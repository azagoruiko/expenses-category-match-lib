...
public class SimpleAlfaMatcher implements Matcher<String>, Serializable {
    private final Collection<? extends ResolverFromString<Set<Tag>>> tagResolvers;

    public SimpleAlfaMatcher(Collection<? extends ResolverFromString<Set<Tag>>> tagResolvers) {
    ...
    private Set<Tag> tagsFromOperationDesc(String operationDesc) {
        ...
        tags.add(SystemTag.SRC_ALFA_BANK.getTag());
