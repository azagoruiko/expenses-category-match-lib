...
public class SimpleSpreadsheetsMatcher implements Matcher<String>, Serializable {
    private final Collection<? extends ResolverFromString<Set<Tag>>> tagResolvers;

    public SimpleSpreadsheetsMatcher(Collection<? extends ResolverFromString<Set<Tag>>> tagResolvers) {
    ...
    private Set<Tag> tagsFromOperationDesc(String operationDesc) {
        ...
        tags.add(SystemTag.SRC_SPREADSHEETS.getTag());
